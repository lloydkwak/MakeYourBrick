...
class JobRequest(BaseModel):
    ...
    fill: bool = True
    voxelizer: Literal["surface", "ray", "slice", "slice-surface"] = "surface"
    ...
    sculpture_mode: Literal["solid", "shell", "contour-shell", "density", "brickformer"] = "solid"
    ...
    support_spacing: int = Field(default=3, ge=0, le=64)
    ...
    color_strategy: Literal["strict", "majority", "layer"] = "strict"
